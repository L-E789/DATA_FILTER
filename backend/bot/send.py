            ...
            <table style="border-collapse: collapse; margin: 0 auto; padding: 10px; text-align: center; position: relative; width: 100%; max-width: 700px; height: 500px;">
                ...
                <tr>
                    <td style="padding: 0px 0px 30px 0px; background-color: #FFF;">
                        <div>
                            <p style="padding-bottom: 10px; font-size: 18px; font-weight: bold; color: rgb(0, 0, 0); font-family: 'Roboto', sans-serif;">¡Bienvenido!, muchas gracias por utilizar nuestro aplicativo web, antes de completar su registro debemos validar si su cuenta es verdadera, esto para evitar un exceso de registros por parte de nuestros usuarios y para otras funcionalidades, por favor oprima en el botón que se encuentra en la parte inferior "Verificar", el cual lo llevará a nuestro aplicativo para completar al 100% su registro.</p>
                            <br>
...
def Send_answer(email,answer):
        ...
        <div class="contenedor">
            <table style="border-collapse: collapse; margin: 0 auto; padding: 10px; text-align: center; position: relative; width: 100%; max-width: 700px; height: 500px;">
                ...
                <tr>
                    <td style="padding: 0px 0px 30px 0px; background-color: #FFF;">
                        <div>
                            <p style="padding-bottom: 10px; font-size: 18px; font-weight: bold; color: rgb(0, 0, 0); font-family: 'Roboto', sans-serif;">{answer}</p>
                        </div>
                    </td>
                </tr>
                <tr style="height: 15px;">
    ...
    msg['From'] = remitente
    msg['To'] = email
    msg['Subject'] = 'Respuesta de CODEGROUP'
    servidor.sendmail(msg['From'] , msg['To'], msg.as_string())